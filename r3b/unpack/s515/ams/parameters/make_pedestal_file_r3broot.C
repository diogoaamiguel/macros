...
void make_pedestal_file_r3broot(){
   ...
   TString c1 = "sidped_r3broot.txt_";
   TString c2 = "sidsig_r3broot.txt_";
   ...
   FairRuntimeDb* rtdb = FairRuntimeDb::instance();
    ...
    TString amsmapdir = dir + "/macros/macros/r3b/unpack/s515/ams/parameters/";
  ...
  parIo2->open("Ams_CalPar_20210424.par","out");
