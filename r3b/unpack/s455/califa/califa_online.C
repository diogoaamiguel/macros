...
void califa_online()
{
    ...
    // Create input -----------------------------------------
    TString filename = "--stream=lxlanddaq01.gsi.de:9000";
    // TString filename = "--stream=lxir123.gsi.de:9760";
    // TString filename = "/lustre/r3b/202006_s444/lmd/main0022_0001.lmd";// global lmd files from s444

    // Output file ------------------------------------------
    TString outputpath = "/lustre/land/202104_s455/rootfiles/califa/";
    // TString outputpath = "/lustre/r3b/202006_s444/rootfiles/";
    TString outputFileName = outputpath + "s455_data_califa_online_" + oss.str() + ".root";
    ...
    Int_t port = 8887; // Port number for the online visualization, example lxgXXXX:8880
    ...
    TString califamapfilename = califadir + "CALIFA_mapping_2March2021.par";
    califamapfilename.ReplaceAll("//", "/");
    // Parameters for CALIFA calibration in keV
    TString califacalfilename = califadir + "CALIFA_Cal_3March2021.par";
    ...
    R3BWhiterabbitMasterReader* unpackWRM =
        new R3BWhiterabbitMasterReader((EXT_STR_h101_WRMASTER*)&ucesb_struct.wrm, offsetof(EXT_STR_h101, wrm), 0x300);
    ...
    CalifaOnline->SetRange_max(3000); // 10MeV
